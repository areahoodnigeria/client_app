  ...
  return (
    <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img
          src={
            "https://thewhistler.ng/wp-content/uploads/2020/12/Millennium-Park-Abuja-1.jpg"
          }
      ...
      <div className="relative z-10 container mx-auto px-4 text-center max-w-4xl">
        <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
          Connect with Your <span className="text-primary">Neighborhood</span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <Button size="lg" className="px-8 py-6 text-lg shadow-soft">
            <Link to="/signup?type=user">Join as a Neighbor</Link>
          </Button>
          <Button variant="outline" size="lg" className="px-8 py-6 text-lg">
            <Link to="/signup?type=organization">Join as an Organization</Link>
          </Button>
        </div>
      </div>
    </section>
